...
def compute_losses_diff(option, src_pcd0, src_pcd, pred_transforms, transform_gt, loss_type = 'mae', reduction = 'mean'):
...
def compute_losses(option, src_pcd, pred_transforms, transform_gt, loss_type = 'mae', reduction = 'mean'):
